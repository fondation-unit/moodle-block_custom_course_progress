...
$string['author'] = 'Author of the export';
$string['author_desc'] = 'Author label of the export file';
$string['summary'] = 'Summary of {$a}';
$string['reportlogo_name'] = 'Logo report';
$string['reportlogo_desc'] = 'Logo on homepage report';
$string['user_can_download_report'] = 'The user can download his own report';
$string['user_can_download_report_desc'] = 'This settings determines if the user is allowed to download his PDF report himself.';
$string['showidlecourses'] = 'Display the idle courses';
$string['showidlecourses_desc'] = 'This settings determines if the block will display the idle courses.';
